...
class UserModel {
  ...
  static async create(deviceId, platformData = {}) {
    ...
    const username = `.gg/sgboxer<color=orange><sup>#${userId}`;
  ...
  static tournaments = [
    {
      ...
      nameKey: "(.gg/sgboxer) 1v1 BD Tounament",
      descriptionKey: "Practice your skills in the Stumble BOXER 1v1 TournamentX! mode!",
      ...
      prizeBannerColour: "#6c00fa",
      headerColour: "#cc00ff",
      mapListGradientColourTop: "#6c00fa",
      mapListGradientColourBottom: "#d400ff",
      listPriority: 1,
      minPlayers: 2,
      maxPlayers: 2,
      maxRounds: 1,
      ...
      detailsPanelBorderColourTop: "#6c00fa",
      detailsPanelBorderColourBottom: "#d400ff",
      colourData: {
        detailsPanelMainColour: "#8c00ff",
        detailsPanelBorderColour: "#ff00ff",
        headerGradientRight: "#8c00ff",
        headerGradientLeft: "#ea00ff",
        infoWidgetsGradientRight: "#8c00ff",
        infoWidgetsGradientLeft: "#8c00ff",
        infoWidgetsBorderColour: "#cc00ff"
      },
      rounds: [
        {
          roundOrder: 1,
    ...
    },
    {
      ...
      startTime: new Date(),
      endTime: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000),
      nameKey: "(.gg/sgboxer) 2v2 BD Tounament",
      descriptionKey: "Practice your skills in the Stumble Infinity 2v2 TournamentX! mode!",
      ...
      prizeBannerColour: "#FF0000",
      headerColour: "#FF0000",
      mapListGradientColourTop: "rgb(255, 0, 0)",
      mapListGradientColourBottom: "#FF0000",
      listPriority: 0,
      minPlayers: 4,
      maxPlayers: 4,
      maxRounds: 1,
      ...
      areEmotesRestricted: false,
      prohibitedEmotes: [7],
      detailsPanelBorderColourTop: "#e00505",
      detailsPanelBorderColourBottom: "#ff0000",
      colourData: {
        detailsPanelMainColour: "#ff0000",
        detailsPanelBorderColour: "rgb(255, 0, 0)",
        headerGradientRight: "rgb(255, 0, 0)",
        headerGradientLeft: "rgb(255, 0, 0)",
        infoWidgetsGradientRight: "rgb(255, 0, 0)",
        infoWidgetsGradientLeft: "rgb(255, 0, 0)",
        infoWidgetsBorderColour: "rgb(255, 0, 0)"
      },
      rounds: [
        {
          roundOrder: 1,
